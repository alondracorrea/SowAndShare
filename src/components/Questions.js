...
function Questions() {
  ...
  const [currentSelectedDropdownOption, setCurrentSelectedDropdownOption] =
    useState("");
  ...
  return (
    <div className="app">
      {showEnd ? (
        <div className="end-section">Thank you for sharing.</div>
      ) : (
        <>
          ...
          <div className="answer-section">
            {questions[currentQuestion].answerOptions.map((answerOption) => {
              if (Array.isArray(answerOption)) {
                ...
                return (
                  <div key={`location-dropdown-${currentQuestion}`}>
                    ...
                    <button
                      className="nextBtn"
                      onClick={() =>
                        handleAnswerOptionClick(currentSelectedDropdownOption)
                      }
                    >
                      Next
                    </button>
              ...
              } else if (answerOption.inputType === "text") {
                // text input
                return (
                  <div key={answerOption.inputType}>
                    ...
                    <button
                      className="nextBtn"
                      onClick={() => handleAnswerOptionClick(textInput)}
                    >
                      Next
                    </button>
                  </div>
                );
              } else if (answerOption.imageUrl) {
                // check for imageUrl
                return (
                ...
                // regular button without an image
                return (
                  <button
                    className="regularBtn"
