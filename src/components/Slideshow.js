...
const Slideshow = () => {
  ...
  const paragraphs = [
    "We take great care of your story. When you submit you decide whether you want to remain annonymous.",
    ...
    "We ensure that decision-makers have access to the data they need to change their story, using something everyone has the right to do: speak up.",
  ];
  ...
  return (
    <div className="slideshow-container">
      ...
      <div className="paragraph-item">
        <h1 className={`p-headers ${currentIndex === 2 ? "header-three" : ""}`}>
